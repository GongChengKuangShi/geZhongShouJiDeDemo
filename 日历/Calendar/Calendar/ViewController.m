...
-(UIButton *)cancelSelectTimeButton{
    if (!_cancelSelectTimeButton) {
        _cancelSelectTimeButton = [[UIButton alloc]initWithFrame:CGRectMake(10, 5, 80, 40)];
        ...
        [_cancelSelectTimeButton setTitle:@"重置" forState:UIControlStateNormal];
...
-(UIButton *)determineSelectTimeButton{
    if (!_determineSelectTimeButton) {
        _determineSelectTimeButton = [[UIButton alloc]initWithFrame:CGRectMake(SCREENWIDTH-90, 5, 80, 40)];
...
//}
//
//- (void)userChar:(char *)charStr {
//    
//    NSMutableArray *array = [[NSMutableArray alloc] init];
//    for (int i = 0; i < 32; i++) {
//        
//        NSNumber *number = [[NSNumber alloc] initWithInt:charStr[i]];
//        [array addObject:number];
//    }
//    [_dictionary setValue:array forKey:@"charStr"];
//    
//}
