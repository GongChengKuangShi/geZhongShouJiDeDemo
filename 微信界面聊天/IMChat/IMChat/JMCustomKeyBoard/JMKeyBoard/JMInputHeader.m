...
- (JMCustomKeyBoardView *)keyView
{
    if (!_keyView) {
        ...
        JMCustomKeyBoardView *keyView = [[JMCustomKeyBoardView alloc] initWithFrame:CGRectMake(0, 0, self.width, 216)];
...
- (JMMoreInputView *)moreImput
{
    if (!_moreImput) {
        ...
        JMMoreInputView *moreImput = [[JMMoreInputView alloc] initWithFrame:CGRectMake(0, 0, self.width, 216)];
